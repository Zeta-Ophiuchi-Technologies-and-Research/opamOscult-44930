...
export function MarkerHighlight({
  ...
  return (
    <motionFramer.span
      ...
      className={cn("inline-block tracking-tight font-bold", baseTextClass, className)}
      style={{
    ...
    >
      ...
      <span style={{ position: "relative", display: "inline-block" }}>
        ...
        <span
          className={cn(
            "transition-colors ease-out mix-blend-multiply",
            highlightTextClass,
          )}
          style={{
            position: "relative",
            zIndex: 1,
            color:
              "isInView ? resolvedHighlightedTextColor : resolvedBaseColor",
...
const ShiningText = ({ before, highlight, after, className }: MarkerHighlightProps) => {
  return (
    <>
      <MarkerHighlight
        before={before}
        highlight={highlight}
        after={after}
        className={cn("text-3xl text-center leading-tight font-medium", className)}
