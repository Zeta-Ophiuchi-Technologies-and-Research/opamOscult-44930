...
"[project]/node_modules/@teispace/next-themes/dist/chunk-BWF5JPTY.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@teispace/next-themes/dist/chunk-QOIAKUAT.js [app-client] (ecmascript)");
;
var s = ({ key: e$1 })=>({
        get () {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])()) return null;
            try {
                return globalThis.localStorage.getItem(e$1);
            } catch  {
                return null;
            }
        },
        set (t) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])()) try {
                globalThis.localStorage.setItem(e$1, t);
            } catch  {}
        },
        subscribe (t) {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])()) return ()=>{};
            let o = (r)=>{
                r.key && r.key !== e$1 || t(r.newValue);
            };
            try {
...
var d = (e)=>{
    let t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])(e), o = s(e);
    return {
        get () {
            let r = t.get();
            if (r !== null) return r;
        ...
        subscribe (r) {
            return o.subscribe ? o.subscribe(r) : ()=>{};
        }
    };
};
var m = ({ key: e })=>({
        get () {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])()) return null;
            try {
                return globalThis.sessionStorage.getItem(e);
            } catch  {
                return null;
            }
        },
        set (t) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])()) try {
...
function _(e) {
    ...
    let t = {
        key: e.key,
        cookie: {
            name: e.cookieOptions?.name ?? e.key,
            maxAge: e.cookieOptions?.maxAge,
            path: e.cookieOptions?.path,
            domain: e.cookieOptions?.domain,
    ...
    switch(e.mode){
        case "cookie":
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])(t);
        case "hybrid":
            return d(t);
        case "local":
            return s(t);
...
"[project]/node_modules/@teispace/next-themes/dist/chunk-QOIAKUAT.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function l(e, o) {
    ...
    for (let n of t){
        let r = n.indexOf("=");
        if (!(r < 0) && n.substring(0, r) === o) {
            let a = n.substring(r + 1);
            if (!a) return null;
            try {
...
function u(e) {
    if (!e) throw new Error("[@teispace/next-themes] cookie name must be non-empty.");
    for(let o = 0; o < e.length; o++){
        let t = e.charCodeAt(o);
        if (p(t) || d.includes(e[o])) throw new Error(`[@teispace/next-themes] invalid cookie name '${e}'. Allowed: RFC 6265 token characters (no control chars, whitespace, or () <> @ , ; : \\ " / [ ] ? = { }).`);
    }
}
function c(e, o) {
    for(let t = 0; t < o.length; t++){
        let n = o.charCodeAt(t);
        if (h(n) || n === 59) throw new Error(`[@teispace/next-themes] invalid cookie ${e} '${o}'. Cookie attributes cannot contain control characters or ';'.`);
    }
}
function m(e, o, t = {}) {
    u(e);
    let n = t.maxAge ?? 3600 * 24 * 365, r = t.path ?? "/", a = t.sameSite ?? "lax";
    c("path", r), t.domain && c("domain", t.domain);
    let i = [
        `${e}=${encodeURIComponent(o)}`,
        `Max-Age=${n}`,
        `Path=${r}`,
        `SameSite=${a.charAt(0).toUpperCase()}${a.slice(1)}`
    ];
    return t.domain && i.push(`Domain=${t.domain}`), t.secure && i.push("Secure"), i.join("; ");
}
var k = ({ cookie: e })=>{
    let { name: o, ...t } = e;
    return u(o), {
...
"[project]/node_modules/@teispace/next-themes/dist/chunk-R5YNVJVV.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function i(e) {
    let t = e.storageKey ?? "theme";
    return {
        storageMode: e.storageMode ?? "hybrid",
        storageKey: t,
        cookieName: e.cookieName ?? t,
        attribute: e.attribute ?? "data-theme",
        themes: e.themes ?? [
            "light",
            "dark"
        ],
        defaultTheme: e.defaultTheme ?? "system",
        enableSystem: e.enableSystem ?? true,
        followSystem: e.followSystem ?? false,
        forcedTheme: e.forcedTheme ?? null,
        initialTheme: e.initialTheme ?? null,
        value: e.value ?? null,
        enableColorScheme: e.enableColorScheme ?? true,
        themeColor: e.themeColor ?? null,
        disableTransitionOnChange: e.disableTransitionOnChange === void 0 || e.disableTransitionOnChange === null ? null : e.disableTransitionOnChange,
        respectReducedMotion: e.respectReducedMotion ?? true,
        target: e.target ?? "html"
    };
}
function c(e) {
    let t = i(e), r = {
        a: Array.isArray(t.attribute) ? t.attribute : [
            t.attribute
        ],
        t: t.themes,
        v: t.value,
        ...
        k: t.storageKey,
        n: t.cookieName,
        s: t.enableSystem ? 1 : 0,
        fs: t.followSystem ? 1 : 0,
        cs: t.enableColorScheme ? 1 : 0,
        tc: t.themeColor,
        dt: t.disableTransitionOnChange,
        rrm: t.respectReducedMotion ? 1 : 0,
        tg: t.target
    };
    return `!function(){try{var c=${a(r)};${n}}catch(e){}}();`;
}
function a(e) {
...
"[project]/node_modules/@teispace/next-themes/dist/chunk-RQE5PXXM.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
var _ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null), Le = {
    theme: "",
    resolvedTheme: "",
    systemTheme: null,
    forcedTheme: null,
...
function ke() {
    j || (j = true, console.warn('[@teispace/next-themes] useTheme() called outside a ThemeProvider. Returning inert values (theme="", themes=[]).'));
}
function y() {
    let e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(_), t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(e ? e.subscribe : Ie, e ? e.getState : J, e ? e.getServerSnapshot : J);
    return e ? {
        ...t,
        setTheme: e.setTheme
    } : (("TURBOPACK compile-time value", "development") !== "production" && ke(), {
        ...t,
        setTheme: xe
    });
}
...
function H({ theme: e, children: t, as: r = "div", attribute: n = "class", value: i, className: s, style: a, ...T }) {
    let v = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        ...
        e
    ]), f = i?.[e] ?? e, g = Array.isArray(n) ? n : [
        n
    ], h = {
        style: a,
        ...T
    }, l = s;
    for (let S of g)S === "class" ? l = l ? `${l} ${f}` : f : h[S] = f;
    return l && (h.className = l), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(_.Provider, {
        value: v,
...
function M(e, t, r, n) {
    return (t != null ? e[t] : void 0) ?? (r != null ? e[r] : void 0) ?? n ?? Object.values(e)[0];
}
function $({ variants: e, fallback: t = null }) {
    let { resolvedTheme: r, theme: n } = y(), i = M(e, r, n, t);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: i ?? null
    });
}
function q({ sources: e, fallbackSrc: t, alt: r, ...n }) {
    let { resolvedTheme: i, theme: s } = y(), a = M(e, i, s, t);
    return a ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("img", {
        src: a,
        alt: r ?? "",
        ...n
    }) : null;
...
function Y(e, t = []) {
    let { theme: r, resolvedTheme: n } = y(), i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
...
function G(e) {
    let { theme: t, resolvedTheme: r } = y(), n = r, i = t, s = (a)=>Object.hasOwn(e, a);
    return s(n) ? e[n] : s(i) ? e[i] : e.default;
}
function Pt(e) {
    return function(r) {
        let n = {
            ...
            let { children: a, ...T } = s;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(e, {
                ...n,
                ...T,
                children: a
            });
        };
        return i.displayName = "TypedThemeProvider", {
            ThemeProvider: i,
            useTheme: y,
            useThemeValue: G,
            useThemeEffect: Y,
...
function Vt() {
    if (!(z || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])())) {
        z = true;
        try {
...
var Ue = "*,*::before,*::after{-webkit-transition:none!important;transition:none!important;-moz-transition:none!important;-o-transition:none!important;}", ne = "(prefers-color-scheme: dark)", Be = "(prefers-reduced-motion: reduce)";
function L() {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])()) return "light";
    try {
        return window.matchMedia(ne).matches ? "dark" : "light";
    } catch  {
        return "light";
    }
}
function re(e) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])()) return null;
    try {
...
function oe(e) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])()) return ()=>{};
    let t;
    try {
        t = window.matchMedia(ne);
    } catch  {
        return ()=>{};
    }
    let r = (i)=>e(i.matches ? "dark" : "light");
    if (typeof t.addEventListener == "function") return t.addEventListener("change", r), ()=>t.removeEventListener("change", r);
    let n = t;
    return typeof n.addListener == "function" ? (n.addListener(r), ()=>n.removeListener?.(r)) : ()=>{};
}
function ie(e, t, r, n, i, s) {
    let a = Array.isArray(t) ? t : [
        t
    ], T = i?.[r] ?? r, v = n !== null ? i?.[n] ?? n : null;
    for (let f of a)if (f === "class") {
        let g = new Set;
        for (let l of s){
            let S = i?.[l] ?? l;
            for (let A of S.split(/\s+/))A && g.add(A);
        }
        if (v) for (let l of v.split(/\s+/))l && g.add(l);
        let h = new Set;
        for (let l of T.split(/\s+/))l && (h.add(l), g.delete(l));
        for (let l of g)e.classList.contains(l) && e.classList.remove(l);
        for (let l of h)e.classList.contains(l) || e.classList.add(l);
    } else e.getAttribute(f) !== T && e.setAttribute(f, T);
}
function se(e, t, r) {
    let n = Array.isArray(t) ? t : [
        t
    ], i = r.split(/\s+/).filter(Boolean);
    for (let s of n)if (s === "class") {
        for (let a of i)if (!e.classList.contains(a)) return false;
    } else if (e.getAttribute(s) !== r) return false;
    return true;
}
function me(e, t) {
    t === "light" || t === "dark" ? e.style.colorScheme = t : e.style.colorScheme = "";
}
var te = "data-teispace-themes";
function ae(e, t, r) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])()) return;
    let n = r ? typeof r == "string" ? r : r[t] ?? r[e] ?? null : null, i = document.querySelector(`meta[name="theme-color"][${te}]`);
    if (!n) {
        i && i.remove();
        return;
    }
    i || (i = document.createElement("meta"), i.name = "theme-color", i.setAttribute(te, ""), document.head.appendChild(i)), i.getAttribute("content") !== n && i.setAttribute("content", n);
}
function le(e, t) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])()) return ()=>{};
    if (t && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])()) try {
        if (window.matchMedia(Be).matches) return ()=>{};
    } catch  {}
    let r = e === true ? Ue : e, n = document.createElement("style");
    return n.appendChild(document.createTextNode(r)), document.head.appendChild(n), document.body && window.getComputedStyle(document.body).opacity, ()=>{
        let i = false, s = ()=>{
            i || (i = true, n.remove());
        }, a = setTimeout(s, 120);
...
function x(e, t, r, n) {
    let i = n;
    return e === "system" && i ? "system" : e && t.includes(e) ? e : r === "system" && i ? "system" : t.includes(r) ? r : t[0] ?? "light";
}
var Fe = "(prefers-reduced-motion: reduce)", Qe = "data-teispace-vt";
function Xe(e) {
    return !e || e === "none" ? null : e === true ? {
        type: "fade"
    } : typeof e == "string" ? {
        type: e
    } : e.type === "none" ? null : e;
...
function je(e, t) {
    return e && typeof e == "object" ? e : e === "center" ? {
        x: t.w / 2,
        y: t.h / 2
    } : ee() ?? {
        x: t.w / 2,
...
function de(e, t) {
    ...
    if (!r) return null;
    if (t && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])()) try {
        if (window.matchMedia(Fe).matches) return null;
    } catch  {}
    let n = r.duration ?? 250, i = r.easing ?? "ease";
    if (r.css) return {
        css: r.css,
        duration: n
    };
    ...
    if (s === "circular") {
        let a$1 = {
            w: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])() ? window.innerWidth : 1024,
            h: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])() ? window.innerHeight : 768
        }, T = je(r.origin, a$1);
        return {
            css: We(T, n, i),
            duration: n
...
::view-transition-new(root) {
  animation: teispace-theme-reveal ${t}ms ${r} both;
  z-index: 2;
  mix-blend-mode: normal;
}
@keyframes teispace-theme-reveal {
  from { clip-path: circle(0 at ${n}px ${i}px); }
  to { clip-path: circle(150vmax at ${n}px ${i}px); }
}`;
}
function ue(e, t) {
    let r = document;
    if (typeof r.startViewTransition != "function") {
        e();
        return;
    }
    let n = document.createElement("style");
    n.setAttribute(Qe, ""), n.appendChild(document.createTextNode(t.css)), document.head.appendChild(n);
    let i = false, s = ()=>{
        i || (i = true, n.parentNode && n.parentNode.removeChild(n));
    }, a = r.startViewTransition(()=>{
        e();
    });
    a?.finished && typeof a.finished.then == "function" ? a.finished.then(s, s) : window.setTimeout(s, t.duration + 50);
}
var Ye = "*,*::before,*::after{-webkit-transition:none!important;transition:none!important;-moz-transition:none!important;-o-transition:none!important;}";
function ce(e, t) {
    if (e === t) return true;
    if (!e || !t) return false;
    let r = Object.keys(e);
    if (r.length !== Object.keys(t).length) return false;
    for (let n of r)if (e[n] !== t[n]) return false;
    return true;
}
function Ge(e, t) {
    return e === t ? true : typeof e == "string" || typeof t == "string" ? false : ce(e, t);
}
function Qt(e$1) {
    let { themes: t, defaultTheme: r, enableSystem: n, initialTheme: i, attribute: s, enableColorScheme: a$1, target: T, storage: v } = e$1, f = e$1.forcedTheme, g = e$1.followSystem, h = e$1.value, l = e$1.themeColor, S = e$1.disableTransitionOnChange, A = e$1.respectReducedMotion, K = e$1.transition, U = e$1.onChange, B = n ? [
        ...t,
        "system"
    ] : t;
    function fe() {
        let o = v.get();
        return o && (o === "system" && n || t.includes(o)) ? o : null;
    }
    function P() {
        let o = L(), u;
        f ? u = f : g && n ? u = "system" : u = fe() ?? i ?? r;
        let m = x(u, t, r, n);
        return {
            theme: m,
            resolvedTheme: m === "system" ? o : m,
            systemTheme: n ? o : null,
            forcedTheme: f ?? null,
            themes: B
        };
    }
    let c = P(), he = c, k = null, I = new Set, E = false, V = null, N = null, O = null;
    function Te() {
        for (let o of I)o(c);
    }
    function D(o, u = false) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])()) return;
        let m = re(T), d = h && h[o.resolvedTheme] != null ? h[o.resolvedTheme] : o.resolvedTheme, b = k === d && se(m, s, d), C = null;
        !u && S && !b && (C = le(typeof S == "string" ? S : Ye, A)), b || ie(m, s, o.resolvedTheme, k, h ?? void 0, B), a$1 && me(m, o.resolvedTheme), ae(o.theme, o.resolvedTheme, l ?? void 0), k = d, C?.();
    }
    function w(o, u = false) {
        let m = c, d = m.theme !== o.theme || m.resolvedTheme !== o.resolvedTheme, b = d || m.systemTheme !== o.systemTheme, C = m.forcedTheme !== o.forcedTheme;
        c = o, d && D(o, u), (b || C) && Te(), d && U?.(o.theme, o.resolvedTheme);
    }
    function pe(o, u) {
        if (f) return;
        let m = typeof o == "function" ? o(c.theme) : o;
        if (!(m === "system" && n) && !t.includes(m)) return;
        let b = x(m, t, r, n), C = (Pe)=>{
            v.set(b);
            let Q = L();
            w({
                ...c,
                theme: b,
                resolvedTheme: b === "system" ? Q : b,
                systemTheme: n ? Q : null
            }, Pe);
        }, Re = u?.transition !== void 0 ? u.transition : K, F = de(Re, A);
        F ? ue(()=>C(true), F) : C(false);
    }
    function ge(o) {
        w({
            ...c,
            systemTheme: o,
            resolvedTheme: c.theme === "system" ? o : c.resolvedTheme
        });
    }
    function ye(o) {
        if (f) return;
        ...
        w({
            ...c,
            theme: u,
            resolvedTheme: u === "system" ? m : u,
            systemTheme: n ? m : null
        });
    }
    function ve() {
        if (E) return;
        E = true;
        let o = P();
        if (o.theme !== c.theme || o.resolvedTheme !== c.resolvedTheme ? w(o, true) : D(c, true), n && (V = oe(ge)), v.subscribe && (N = v.subscribe(ye)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$QOIAKUAT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])()) {
            let u = (m)=>{
                if (!m.persisted) return;
                let d = P();
                (d.theme !== c.theme || d.resolvedTheme !== c.resolvedTheme) && w(d, true);
            };
            try {
                window.addEventListener("pageshow", u), O = ()=>window.removeEventListener("pageshow", u);
            } catch  {
                O = null;
            }
        }
    ...
    function Se() {
        E = false, V?.(), N?.(), O?.(), V = null, N = null, O = null;
    }
    function be(o) {
        return I.add(o), ()=>{
            I.delete(o);
    ...
    function we(o) {
        ...
        if ("themeColor" in o) {
            let d = o.themeColor ?? null;
            Ge(l, d) || (l = d, u = true);
        }
        "disableTransitionOnChange" in o && o.disableTransitionOnChange !== void 0 && (S = o.disableTransitionOnChange), "respectReducedMotion" in o && o.respectReducedMotion !== void 0 && (A = o.respectReducedMotion), "transition" in o && (K = o.transition), "onChange" in o && (U = o.onChange);
        let m = false;
        if ("followSystem" in o && o.followSystem !== void 0 && (g !== o.followSystem && (m = true), g = o.followSystem), "forcedTheme" in o) {
            let d = f;
            f = o.forcedTheme ?? null, d !== f && (m = true);
        }
        if (m) {
            let d = P();
            w(d, true);
...
function jt(e, t, r) {
    let n = typeof e == "object" && e !== null, i = n ? e.mode : e ?? "hybrid", s = t ?? (n ? e.key : void 0) ?? "theme", a = r ?? (n ? e.cookieOptions : void 0);
    return {
        mode: i,
        key: s,
        cookieOptions: a
...
"[project]/node_modules/@teispace/next-themes/dist/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$RQE5PXXM$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@teispace/next-themes/dist/chunk-RQE5PXXM.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$BWF5JPTY$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@teispace/next-themes/dist/chunk-BWF5JPTY.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$R5YNVJVV$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@teispace/next-themes/dist/chunk-R5YNVJVV.js [app-client] (ecmascript)");
...
;
;
var G = "*,*::before,*::after{-webkit-transition:none!important;transition:none!important;-moz-transition:none!important;-o-transition:none!important;}";
function u(H) {
    let { children: K, themes: c = [
        "light",
        "dark"
    ], defaultTheme: h = "system", forcedTheme: r, enableSystem: f = true, followSystem: t = false, attribute: T = "data-theme", value: n, target: d$1 = "html", storage: L, storageKey: _, cookieOptions: w, disableTransitionOnChange: e = false, respectReducedMotion: i$1 = true, enableColorScheme: S = true, themeColor: m, initialTheme: g, nonce: D, noScript: N = false, scriptProps: V, transition: a$2, onChange: l } = H, { mode: y, key: p, cookieOptions: C } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$RQE5PXXM$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["k"])(L, _, w), o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    o.current || (o.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$RQE5PXXM$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"])({
        themes: c,
        defaultTheme: h,
        enableSystem: f,
        forcedTheme: r ?? null,
        ...
        respectReducedMotion: i$1,
        target: d$1,
        storage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$BWF5JPTY$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])({
            mode: y,
            key: p,
            cookieOptions: C
        }),
        ...
        "u.useEffect": ()=>{
            let s = o.current;
            return s?.mount(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$RQE5PXXM$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"])(), ({
                "u.useEffect": ()=>{
                    s?.unmount();
                }
            })["u.useEffect"];
        }
    }["u.useEffect"], []), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "u.useEffect": ()=>{
            o.current?.update({
                forcedTheme: r ?? null,
                followSystem: t,
    ...
    let v = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerInsertedHTML"])({
        "u.useServerInsertedHTML": ()=>{
            if (v.current || N) return null;
            v.current = true;
            let s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$R5YNVJVV$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])({
                storageMode: y,
                storageKey: p,
                cookieName: C?.name ?? p,
                attribute: T,
                ...
                enableColorScheme: S,
                themeColor: m ?? null,
                disableTransitionOnChange: e === true ? G : typeof e == "string" ? e : null,
                respectReducedMotion: i$1,
                target: d$1
            });
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("script", {
                ...V,
                nonce: D,
    ...
    }["u.useServerInsertedHTML"]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$RQE5PXXM$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"].Provider, {
        value: o.current,
        children: K
    });
}
var me = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$teispace$2f$next$2d$themes$2f$dist$2f$chunk$2d$RQE5PXXM$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])(u);
;
}),
...
//# sourceMappingURL=node_modules_0f--7m_._.js.map